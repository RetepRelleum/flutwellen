...
SOURCES = \
	__init__.py \
	Flutwellen.py Flutwellen_dialog.py

PLUGINNAME = Flutwellen

PY_FILES = \
	__init__.py \
	Flutwellen.py Flutwellen_dialog.py

UI_FILES = Flutwellen_dialog_base.ui
...
QGISDIR=/home/retep/.local/share/QGIS/QGIS4/profiles/default/python/plugins
